...
from src.fantasy_tactics_gameplay.special_mechanics.capture_system import CaptureHandler
from src.fantasy_tactics_gameplay.systems.staff_handler import StaffHandler
...
class CombatSystem:
    ...
    def initialize(self, gameStateManager_instance: GameStateManager, dataProvider_instance: DataProvider,
        ...
        from src.fantasy_tactics_gameplay.combat.combat_executor import CombatExecutor
