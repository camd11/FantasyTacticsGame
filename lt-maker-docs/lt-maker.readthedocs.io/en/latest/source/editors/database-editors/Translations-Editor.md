...
- <a href="../index.html" class="reference internal">Editors</a>
  ...
  - <a href="index.html" class="reference internal">Database Editors</a>
    ...
    - <a href="Translations-Editor.html#"
      class="current reference internal">Translations Editor</a>
      - <a href="Translations-Editor.html#title-screen-text"
        class="reference internal">Title Screen Text</a>
      - <a href="Translations-Editor.html#event-region-text"
        class="reference internal">Event Region Text</a>
...
- Translations Editor
- <a
  href="https://gitlab.com/rainlash/lt-maker/blob/master/docs/source/editors/database-editors/Translations-Editor.md"
...
<div id="translations-editor" class="section">

# Translations Editor<a href="Translations-Editor.html#translations-editor"
class="headerlink" title="Link to this heading"></a>

*last updated 2024-11-13*

This editor is mainly used to provide info text (also known as R-text)
for various menu options, as well as to fill out generic dialogue
options such as for shops. For help with supporting non-English
languages, refer to the <a
href="../../guides/setup_tutorials/Fonts-And-Languages.html#fonts-guide"
class="reference internal"><span class="std std-ref">Fonts and Languages
Guide</span></a>.

<div id="title-screen-text" class="section">

## Title Screen Text<a href="Translations-Editor.html#title-screen-text" class="headerlink"
title="Link to this heading"></a>

To replace the text that says ‘\_attribution’ on the title screen of
your project, simply add an entry to the translations with the NID
<span class="pre">`_attribution`</span>.

</div>

<div id="event-region-text" class="section">

## Event Region Text<a href="Translations-Editor.html#event-region-text" class="headerlink"
title="Link to this heading"></a>

If you create an event region, such as an Escape or Seize event, using
the <span class="pre">`INFO`</span> button on that command in the menu
will cause the default text ‘EVENTNAME_desc’ to appear. This can be
replaced with meaningful text by adding an entry with that NID in the
translations editor.
...
<a href="Raw-Data-Editor.html" class="btn btn-neutral float-left"
accesskey="p" rel="prev" title="Raw Data Editor"><span
class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
<a href="../resource-editors/index.html"
class="btn btn-neutral float-right" accesskey="n" rel="next"
title="Resource Editors">Next <span class="fa fa-arrow-circle-right"
