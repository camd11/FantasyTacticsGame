...
- <a href="../index.html" class="reference internal">Editors</a>
  ...
  - <a href="index.html" class="reference internal">Database Editors</a>
    ...
    - <a href="Factions-Editor.html" class="reference internal">Factions
      Editor</a>
    - <a href="Party-Editor.html#" class="current reference internal">Party
      Editor</a>
      - <a href="Party-Editor.html#party-convoys"
        class="reference internal">Party Convoys</a>
...
- Party Editor
- <a
  href="https://gitlab.com/rainlash/lt-maker/blob/master/docs/source/editors/database-editors/Party-Editor.md"
...
<div id="party-editor" class="section">

# Party Editor<a href="Party-Editor.html#party-editor" class="headerlink"
title="Link to this heading"></a>

*last updated 2024-11-11*

<div id="party-convoys" class="section">

## Party Convoys<a href="Party-Editor.html#party-convoys" class="headerlink"
title="Link to this heading"></a>

Each party in an LT game has a unique convoy. If you wish for two or
more parties to share a convoy, units will have to be added to/removed
from the ‘main party’ each time to ensure the convoy is preserved.
...
<a href="Factions-Editor.html" class="btn btn-neutral float-left"
accesskey="p" rel="prev" title="Factions Editor"><span
class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
<a href="Classes-Editor.html" class="btn btn-neutral float-right"
accesskey="n" rel="next" title="Classes Editor">Next <span
