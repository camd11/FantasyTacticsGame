...
- <a href="../index.html" class="reference internal">Editors</a>
  ...
  - <a href="index.html" class="reference internal">Database Editors</a>
    ...
    - <a href="Supports-Editor.html" class="reference internal">Supports
      Editor</a>
    - <a href="Lore-Editor.html#" class="current reference internal">Lore
      Editor</a>
...
- Lore Editor
- <a
  href="https://gitlab.com/rainlash/lt-maker/blob/master/docs/source/editors/database-editors/Lore-Editor.md"
...
<div id="lore-editor" class="section">

# Lore Editor<a href="Lore-Editor.html#lore-editor" class="headerlink"
title="Link to this heading"></a>

*last updated 2024-11-13*

By default, lore is not visible in-game until added using the
<span class="pre">`add_lore`</span> event command. Additionally, only
lore with ‘Guide’ in the Category field will be displayed in the Guide
menu option.
...
<a href="Supports-Editor.html" class="btn btn-neutral float-left"
accesskey="p" rel="prev" title="Supports Editor"><span
class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
<a href="Raw-Data-Editor.html" class="btn btn-neutral float-right"
accesskey="n" rel="next" title="Raw Data Editor">Next <span
