...
- <a href="../index.html" class="reference internal">Editors</a>
  ...
  - <a href="index.html" class="reference internal">Database Editors</a>
    ...
    - <a href="Teams-Editor.html#" class="current reference internal">Teams
      Editor</a>
      - <a href="Teams-Editor.html#banner-displays"
        class="reference internal">Banner Displays</a>
...
- Teams Editor
- <a
  href="https://gitlab.com/rainlash/lt-maker/blob/master/docs/source/editors/database-editors/Teams-Editor.md"
...
<div id="teams-editor" class="section">

# Teams Editor<a href="Teams-Editor.html#teams-editor" class="headerlink"
title="Link to this heading"></a>

*last updated 2024-11-11*

<div id="banner-displays" class="section">

## Banner Displays<a href="Teams-Editor.html#banner-displays" class="headerlink"
title="Link to this heading"></a>

When adding teams, new banner images will need to be provided for each
new team’s phase start. These should be in the format
<span class="pre">`turnbanner_TEAMNAME`</span> and can be placed in the
custom_sprites directory of your project.

For example, if you create a team named
<span class="pre">`enemy3`</span>, you should place an image like the
below named <span class="pre">`turnbanner_enemy3.png`</span> in your
custom_sprites directory. Otherwise, a small error square will show up
instead.

![Enemy3](./media/c73937b16dc3f090a7b282606719daeabea1b1ba.png)

Note that you can create new banners for existing teams as well by
...
<a href="Units-Editor.html" class="btn btn-neutral float-left"
accesskey="p" rel="prev" title="Units Editor"><span
class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
<a href="Factions-Editor.html" class="btn btn-neutral float-right"
accesskey="n" rel="next" title="Factions Editor">Next <span
