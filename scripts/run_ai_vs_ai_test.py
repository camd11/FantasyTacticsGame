...
if os.path.exists('src/fantasy_tactics_gameplay/ai/ai_system.py'):
    shutil.copy('src/fantasy_tactics_gameplay/ai/ai_system.py', 'src/fantasy_tactics_gameplay/ai/ai_system.py.bak')

if os.path.exists('test_ai_vs_ai.py'):
    shutil.copy('test_ai_vs_ai.py', 'test_ai_vs_ai.py.bak')

# Replace with modified files
# shutil.copy('src/fantasy_tactics_gameplay/ai/ai_system_fixed.py', 'src/fantasy_tactics_gameplay/ai/ai_system.py') # Commented out to prevent overwrite
...
try:
    ...
    if os.path.exists('src/fantasy_tactics_gameplay/ai/ai_system.py.bak'):
        shutil.copy('src/fantasy_tactics_gameplay/ai/ai_system.py.bak', 'src/fantasy_tactics_gameplay/ai/ai_system.py')
        os.remove('src/fantasy_tactics_gameplay/ai/ai_system.py.bak')
